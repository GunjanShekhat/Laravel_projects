...
<body>
     ...
     <form class="my-form" action="{{ route('house.update') }}" method="post" style="margin-top:70px;">
          @csrf
          <input type="hidden" value="{{ $house->house_id }}" name="id" />
          <p>
               <label for="houseName">House Name *</label>
               <span class="wrap">
                    <input type="text" name="houseName" class="form-control text" id="houseName"
          ...
          <p>
               ...
               <span class="wrap">
                    <textarea name="address" cols="40" rows="5" class="textarea" id="address" aria-invalid="false"
          ...
          <p>
               ...
               <span class="wrap">
                    <input type="text" name="city" value="{{ $house->city }}" class="form-control text" id="city"
                         required />
               </span>
          </p>
          <p>
               ...
               <span class="wrap">
                    <input type="text" name="state" value="{{ $house->state }}" class="form-control text" id="state"
                         required />
               </span>
          </p>
          <p>
               ...
               <span class="wrap">
                    <input type="text" name="rent" value="{{ $house->rent_per_month }}" class="form-control text"
                         id="rent" required />
               </span>
          </p>
          <!-- <p>
          ...
          <p class="cta-holder">
               <input type="submit" value="Update" class="cta-button" />
          </p>
     </form>
