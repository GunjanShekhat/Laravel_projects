          ...
          <section class="section-md bg-default">
               <div class="container">
                    ...
                    <div style="display:flex;justify-content:center;">
                         ...
                         <form action="userCreate" style="width:40%;" method="POST">
                              <center>
                                   <h4>Sign Up</h4>
                              </center>
                              @csrf
                              ...
                              <div class="form-wrap">
                                   ...
                                   <input class="form-input" type="email" id="u_email" name="u_email"
                                        placeholder="Enter your Email (will be used for login)" required />
                              </div>
                              ...
                              <div class="form-wrap">
                                   ...
                                   <input type="text" class="form-input" id="u_contact" name="u_contact"
                                        placeholder="Enter Contact Number Here" required>
                              </div>
                              ...
                              <div class="form-wrap">
                                   ...
                                   <input type="text" class="form-input" id="u_address" name="u_address"
                                        placeholder="Enter Your Personal Address Here" required>
                              </div>
                              ...
                              <div class="form-wrap">
                                   ...
                                   <input type="text" class="form-input" id="u_area" name="u_area"
                                        placeholder="Enter Nearest Area Here" required>
                              </div>
                              ...
                              <div class="form-wrap">
                                   ...
                                   <input type="text" class="form-input" id="u_occupation" name="u_occupation"
                                        placeholder="Enter Your Occupation Here" required>
                              </div>

                              <input type="submit" id="submitbtn" class="button" value="Sign Up" style="width:100%;"
                                   disabled>
                              <div>
                                   <div>
