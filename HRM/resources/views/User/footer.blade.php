...
<!-- <section class="section-md bg-accent text-center text-lg-left">
     <div class="container">
          <div class="row row-30 justify-content-md-center align-items-lg-center justify-content-xl-between">
               ...
               <div class="col-md-10 col-lg-6">
                    --------------RD Mailform-----------
<form class="rd-mailform rd-mailform-inline-flex rd-mailform-inline-flex-1 text-center"
     ...
     <div class="form-wrap">
          ...
          <label class="form-label form-label-sm" for="footer-email">Enter your
               e-mail</label>
     </div>
...
<section class="pre-footer-corporate bg-default">
     <div class="container"><a class="brand" href="index-2.html">
               <!-- Logo--><img class="logo-image-default" src="images/logo-default-374x103.png" alt="Estancy"
                    width="187" height="51" /><img class="logo-image-inverse" src="images/logo-inverse-374x103.png"
                    alt="Estancy" width="187" height="51" />
          </a>
          <div class="row justify-content-sm-center justify-content-md-start row-30 row-md-60">
               <div class="col-sm-7">
                    ...
                    <p class="rights">&copy;&nbsp;<span id="copyright-year"></span>.
                         &nbsp;Estancy. All Right Reserved.<span>&nbsp;</span><a class="link-primary"
                         ...
                         <li>
                              <div class="unit flex-row unit-spacing-xs">
                                   <div class="unit-left"><span
                                             class="icon icon-sm icon-primary custom-font-pin"></span></div>
                                   <div class="unit-body"><a class="link-inherit" href="#">410 S Missouri St,
                                             Indianapolis, IN 46225, USA</a></div>
                              </div>
                         </li>
                         <li>
                              <div class="unit flex-row unit-spacing-xs">
                                   <div class="unit-left"><span
                                             class="icon icon-sm icon-primary custom-font-phone"></span></div>
                                   <div class="unit-body"><a class="link-inherit" href="tel:#">+1.777.999.5000</a>
                                   </div>
                              </div>
                         </li>
                         <li>
                              <div class="unit flex-row unit-spacing-xs">
                                   <div class="unit-left"><span
                                             class="icon icon-sm icon-primary custom-font-email"></span></div>
